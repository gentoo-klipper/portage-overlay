...
src_compile() {
	...
	flags="${flags} BL32=${ROOT}/opt/op-tee/tee-header_v2.bin"
	flags="${flags} BL32_EXTRA1=${ROOT}/opt/op-tee/tee-pager_v2.bin"
	flags="${flags} BL32_EXTRA2=${ROOT}/opt/op-tee/tee-pageable_v2.bin"
